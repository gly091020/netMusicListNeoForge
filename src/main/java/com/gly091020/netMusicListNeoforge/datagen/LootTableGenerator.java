...
public class LootTableGenerator extends LootTableProvider {
    ...
    public static class BookLootTable implements LootTableSubProvider{
        ...
        public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> consumer) {
            consumer.accept(ResourceKey.create(Registries.LOOT_TABLE, Identifier.fromNamespaceAndPath(NetMusicList.ModID, "book")),
            ...
            consumer.accept(ResourceKey.create(Registries.LOOT_TABLE, Identifier.fromNamespaceAndPath(NetMusicList.ModID, "cat_dj")),
                    new LootTable.Builder().withPool(
                            new LootPool.Builder()
                                    .setRolls(ConstantValue.exactly(1))
        ...
        private static ItemMusicCD.SongInfo getCatDJTag(){
            ...
            songInfo.artists = List.of("AcidGold");
